...
class Paciente(models.Model):
    ...
    contato_1 = models.CharField(max_length=100, verbose_name="Contato 1", null=True, blank=True)
    telefone_paciente2 = models.CharField(max_length=20, verbose_name="Telefone 2", null=True, blank=True)
    contato_2 = models.CharField(max_length=100, verbose_name="Contato 2", null=True, blank=True)
