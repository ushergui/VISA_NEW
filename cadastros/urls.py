...
from .views import EstadoUpdate, CidadeUpdate, BairroUpdate, LogradouroUpdate, \
    ProprietarioUpdate, TerrenoUpdate, ProtocoloUpdate, FiscalUpdate, InspecaoUpdate, InfracaoUpdate, DefesaUpdate, ARCreate, DefesasCreate, ReinspecoesCreate, ARJulgamento# ReinspecaoUpdate
...
from .views import EstadoList, CidadeList, BairroList, LogradouroList, \
    ProprietarioList, TerrenoList, ProtocoloList, FiscalList, InspecaoList, InfracaoList, InfracaoList2, InformacoesList, ProdutividadeList, GerenciarList, ProdutividadeList2, InfracaoListFilterAtivos #ReinspecaoList
