...
from .views import PaginaInicial, SobreView, EmpresasView, PaginaInicial3 #O ponto no início significa que está pegando um arquivo dentro daquele diretório
